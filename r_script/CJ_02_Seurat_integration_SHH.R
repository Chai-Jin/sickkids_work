...
p=DimPlot(SHH_whole_final, reduction = "harmony", group.by="orig.ident",label=TRUE)
p+ theme(axis.ticks=element_blank(),axis.text=element_blank())
p=DimPlot(SHH_whole_final,reduction = "harmony",label=TRUE, group.by="Phase")
p+ theme(axis.ticks=element_blank(),axis.text=element_blank())
p=DimPlot(SHH_whole_final, reduction = "harmony",label=TRUE)
p+ theme(axis.ticks=element_blank(),axis.text=element_blank())
p=DimPlot(SHH_whole_final, reduction = "harmony",label=TRUE,split.by="orig.ident")
p+ theme(axis.ticks=element_blank(),axis.text=element_blank())
dev.off()
